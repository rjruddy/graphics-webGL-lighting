 ...
 `attribute vec4 a_Position; 			// vertex position (model coord sys)
  attribute vec4 a_Normal;				// vertex normal vector (model coord sys)
	...
	//-------------UNIFORMS: values set from JavaScript before a drawing command.
 	uniform vec3 u_Kd;							// Phong diffuse reflectance for entire 3Dpart
  uniform int u_Kshiny;						// Phong Reflectance Exponent: 1 to 128
...
//	  v_Kd = vec3(1.0, 1.0, 0.0); // TEST; color fixed at green
  }`;
...
//  uniform vec3 u_Lamp0Pos; 			// Phong Illum: position
...
//	uniform vec3 u_Lamp0Spec;			// Phong Illum: specular
  ...
  uniform int u_Kshiny;					// Phong Reflectance: 1 < shiny < 128
//
